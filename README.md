...
1. Include Classes:
source("C:\\Users\\Rodrigo\\main.windows.r")
or
source("/home/rodrigos/main.linux.r")

2. Create a Data Source Info:
dataSourceInfo <- FileDataSourceInfo(type = "kml", path = "/home/rodrigos/elephant_tracking_40_41.kml")
or
...
6. Retrieve Data:
track <- getTrajectory(translator, layer = "argo_profiles_geom", objectId = 46027)
or
